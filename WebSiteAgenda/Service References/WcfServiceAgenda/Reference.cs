...
namespace WebSiteAgenda.WcfServiceAgenda {
    ...
    public interface IServiceAgenda {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAgenda/GetAllPlanningElementByLieuAndEvent", ReplyAction="http://tempuri.org/IServiceAgenda/GetAllPlanningElementByLieuAndEventResponse")]
        WebSiteAgenda.WcfServiceAgenda.PlanningElementWS[] GetAllPlanningElementByLieuAndEvent(string login, string passwd, System.Guid guidLieu, System.Guid guidEv);
    ...
    public partial class ServiceAgendaClient : System.ServiceModel.ClientBase<WebSiteAgenda.WcfServiceAgenda.IServiceAgenda>, WebSiteAgenda.WcfServiceAgenda.IServiceAgenda {
        ...
        public WebSiteAgenda.WcfServiceAgenda.PlanningElementWS[] GetAllPlanningElementByLieuAndEvent(string login, string passwd, System.Guid guidLieu, System.Guid guidEv) {
            return base.Channel.GetAllPlanningElementByLieuAndEvent(login, passwd, guidLieu, guidEv);
        }
        
        public System.Threading.Tasks.Task<WebSiteAgenda.WcfServiceAgenda.PlanningElementWS[]> GetAllPlanningElementByLieuAndEventAsync(string login, string passwd, System.Guid guidLieu, System.Guid guidEv) {
